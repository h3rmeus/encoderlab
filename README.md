...
- `tkinter` входит в стандартную поставку Python на Windows и macOS. На Linux установите отдельно:
```bash
sudo apt install python3-tk
```
- Азбука Морзе и шифр Цезаря поддерживают только латиницу и цифры.
- ASCII Hex работает только с символами ASCII (коды 0–127).
